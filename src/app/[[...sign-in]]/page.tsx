...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen flex">
      ...
      {/* Right Section */}
      <div className="w-1/2 flex items-center justify-center bg-darkyellow/90">
        <SignIn.Root>
          <SignIn.Step
            name="start"
            className="bg-lightgrey/60 p-12 rounded-xl shadow-2xl flex flex-col gap-6 shadow-[0px_0px_80px_10px_rgba(0,0,0,0.6)]"
          >
            ...
            <div className="relative flex items-center">
                ...
                <Clerk.Input
                  ...
                  className="pl-10 p-2 w-full rounded-xl placeholder-gray-400"
                />
              </div>
