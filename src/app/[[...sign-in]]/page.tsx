    ...
    return (
      <div className="fixed top-0 right-0 h-screen w-screen z-50 flex justify-center items-center">
        <div className="relative">
          <div className="animate-spin rounded-full h-32 w-32 border-t-4 border-b-4 border-lightyellow"></div>
          <p className="absolute inset-0 flex items-center justify-center text-lg font-bold text-darkgrey">
            Loading...
          </p>
        </div>
      </div>
    ...
    <ThemeProvider attribute="class" defaultTheme="dark" enableSystem={false}>
      <div className="h-screen flex flex-col justify-between p-8 md:p-12 bg-light dark:bg-dark relative text-white">
        ...
        <div className="flex gap-4 relative z-10 items-center justify-center md:justify-start">
          <Image src="/logo.gif" alt="Logo" width={100} height={100} unoptimized />
          ...
          >
            {theme === "dark" ? <LuLightbulbOff size={32} className="text-lightyellow" /> : <LuLightbulb  size={32} className="text-black" />}
          </button>
        </div>
        <div className="flex md:w-1/2 md:ml-auto flex-col gap-4 items-center justify-center">
          <SignIn.Root>
            <SignIn.Step
              name="start"
              className="z-10 bg-lightgrey/60 dark:bg-darkgrey/60 p-8 md:p-12 rounded-xl shadow-2xl flex flex-col gap-6 
            ...
            >
              ...
              <Clerk.Field name="identifier" className="flex flex-col gap-1">
                <div className="relative flex items-center">
                  ...
                  <Clerk.Input
                    ...
                    className="pl-10 p-2 w-full rounded-xl placeholder-gray-400 text-black dark:text-white dark:bg-black/70"
                  />
                </div>
              ...
              <SignIn.Action
                submit
                className="bg-darkgrey dark:bg-darkyellow text-white my-1 rounded-xl text-lg p-[8px] hover:bg-darkgrey/75 dark:hover:bg-darkyellow/60 transition duration-300 w-full"
              >
                Sign In
              </SignIn.Action>
            </SignIn.Step>
