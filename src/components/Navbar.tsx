...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center rounded-full m-2 justify-between p-4 transition-colors bg-lightyellow dark:bg-darkgrey text-black dark:text-text">
      {/* SEARCH BAR */}
      ...
      <div className="flex items-center gap-4 justify-end w-full">
        ...
        <div className="flex flex-col">
          <span className="text-xs text-black dark:text-yellow leading-3 font-medium">{user?.fullName || "User"}</span>
